...
print(val2[::-1]) # пишем строку задом наперед
print(val2.replace('а', 'i')) # метод замены части строки на что=то другое (заменятся все совпадения)
print(val2.replace('а', 'd', 2)) # метод замены элемента на другой кол-во раз